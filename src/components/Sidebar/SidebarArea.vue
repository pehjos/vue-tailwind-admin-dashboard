  ...
  >
    ...
    <div class="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
      <router-link to="/" class="flex items-center gap-2">
        <img class="h-[70px] rounded-full" src="@/assets/images/logo/logo.jpg" alt="Logo" />
        <h3 class="text-2xl font-semibold text-white">Ghana News</h3>
      </router-link>
    ...
    <div class="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
      ...
      >
        <h3 class="mb-1 font-semibold text-white">Upgrade your plan</h3>
        <p class="mb-4 text-xs">Reach more readers and grow your audience</p>
        <a
